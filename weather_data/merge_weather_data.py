...
def merge_weather_files(input_dir='weather_data', output_file='merged_weather_data.csv'):
    """
    合并weather_data目录下的所有CSV文件
...
if __name__ == '__main__':
    ...
    # 执行合并
    merge_weather_files('weather_data', output_file) 